...
This example describes how to use sleep uart api in tickless sleepCG.
...
Open the Trace Tool and set baud rate to ¡°115200¡±, Data Bits ¡°8¡±, no parity, ¡± 1¡± stop bit for Usb to TTL Adapter.
...
Note: user need to ENABLE the LOW_POWER_RX_ENABLE in array uart_config[] in rtl8710b_intfcfg.c to enable uart low power rx function
      ...
      user need to register sleep callback function as the demo do for UART device.