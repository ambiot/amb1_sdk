...
-(void)inputPINcode
{
    cfg_alertController = [UIAlertController
                           ...
                           message:@"The PIN code will be display on device."
    ...
    UIAlertAction *okAction = [UIAlertAction actionWithTitle:@"OK" style:UIAlertActionStyleDefault handler:^(UIAlertAction *action) {
        ...
        //[NSThread detachNewThreadSelector:@selector(configAction:) toTarget:self withObject:PIN_cfg];
    ...
    [cfg_alertController addAction:cancelAction];
}
*/
...
- (void)CheckConfigDeviceNumber
{
    ...
    cfgNumber_actionSheet = [[UIActionSheet alloc]
                             initWithTitle:@"Select number of devices to be configured."
                             delegate:self
...
- (IBAction)rtk_start_listener:(id)sender
{
    ...
    if(isTipSoftAP){
        ...
        isTipSoftAP = NO;
        NSString *msg = @"Name: @RSC-XXXXXXXXXX\nPassword:          12345678\n\nAfter the device connected, you need to back to this APP immediately.";
        
        UIAlertController *dialog_softAP = [UIAlertController alertControllerWithTitle:@"Pelease connect your device \non WiFi setting to contiune.\n"
                                                                                     message:msg
                                                                              preferredStyle:UIAlertControllerStyleAlert];
        UIAlertAction *okAction = [UIAlertAction actionWithTitle:@"OK" style:UIAlertActionStyleDefault handler:^(UIAlertAction *action) {
...
-(void)alertmsg_connectback
{
    ...
    UIAlertController *dialog_softAP = [UIAlertController alertControllerWithTitle:@"Pelease connect target AP \non WiFi setting to contiune.\n"
                                                                           message:msg
                                                                    preferredStyle:UIAlertControllerStyleAlert];
    UIAlertAction *okAction = [UIAlertAction actionWithTitle:@"OK" style:UIAlertActionStyleDefault handler:^(UIAlertAction *action) {
...
-(void)actionSheet:(UIActionSheet *)actionSheet clickedButtonAtIndex:(NSInteger)buttonIndex
{
    ...
    if (actionSheet.tag == tag_cfg_setNumber){
        ...
        if(buttonIndex==8){//to use pin code
            [self inputPINcode];
        }else{
            ...
            [simpleConfig rtk_sc_config_set_devNum:deviceNum];
